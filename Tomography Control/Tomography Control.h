...
#define WM_USER_TABLE_INPUT_RECEIVED (WM_USER_FRAME_CAPTURED + 1) 
#define WM_USER_TABLE_OUTPUT_FINISHED (WM_USER_TABLE_INPUT_RECEIVED + 1) 
#define WM_USER_RUN_TURN_COMPLETED (WM_USER_TABLE_OUTPUT_FINISHED + 1) 
...
#define WM_USER_BEAM_FAILURE (WM_USER_RUN_FINISHED + 1) 
