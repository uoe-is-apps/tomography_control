...
#define WM_USER_TABLE_MESSAGE_RECEIVED (WM_USER_THREAD_FINISHED + 1) 
#define WM_USER_RUN_TURN_COMPLETED (WM_USER_TABLE_MESSAGE_RECEIVED + 1) 
...
#define WM_USER_RUN_CAPTURING_FRAME (WM_USER_RUN_STOP_COMPLETED + 1) 
#define WM_USER_RUN_FRAME_CAPTURED (WM_USER_RUN_CAPTURING_FRAME + 1) 
#define WM_USER_RUN_FINISHED (WM_USER_RUN_FRAME_CAPTURED + 1) 
#define WM_USER_MANUAL_FRAME_CAPTURED (WM_USER_RUN_FRAME_CAPTURED + 1) 
