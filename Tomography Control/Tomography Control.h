...
// progress
#define WM_USER_TABLE_MESSAGE_RECEIVED (WM_USER + 1) 
...
#define WM_USER_RUN_IMAGE_CAPTURED (WM_USER_RUN_STOP_COMPLETED + 1) 
#define WM_USER_RUN_FINISHED (WM_USER_RUN_IMAGE_CAPTURED + 1) 
// #define WM_USER_MANUAL_IMAGE_CAPTURED (WM_USER_RUN_FINISHED + 1) 
